    ...
    <div class="row">
      <div class="col">
        <div class="d-flex flex-column bd-highlight">
          <div class="bd-highlight imahe">
            <img v-if="currentProduct.images" v-bind:src="currentProduct.images[0].img" />
          </div>
      ...
      <div class="col">
        <div class="d-flex flex-column bd-highlight">
          ...
          <div class="bd-highlight london mt-5">{{currentProduct.shortDescription}}</div>
          <div class="bd-highlight mt-5 describe">
            <h6>Description</h6>
            <p
              class="w-75"
            >A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart. I am alone, and feel the.</p>
