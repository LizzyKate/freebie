...
<div class="comp d-flex justify-content-center align-items-center">
       <div class="ipsum team">
    <p class="mb-0">Do you have any question about our products, pricing or anything else? Our team is ready to answer all your questions</p>
    <h2 class="text-center mb-0">We'd love to hear from you</h2>
    </div>
  ...
  <div class="mt-3 bd-highlight ipsum team">
    <p class="text-center">We are only a call away.<br> Just pick up the phone and chat with us.</p>
  </div>
  <div class="mt-3 bd-highlight">
    <a href="tel:+2348110449018" class="tel"> +234-81-1044-9018</a>
  </div>
</div>
    </div>
